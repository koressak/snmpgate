...
\begin{figure}[htp]
	\begin{center}
		...
		\caption{Schéma datových paketů protokolu SNMPv1 a v2 (obrázek 2.5, \cite{macejko_dipl} )}
		\label{obr_snmp3}
	\end{center}
\end{figure}
...
\begin{figure}[htp]
	\begin{center}
		...
		\caption{Schéma datového paketu protokolu SNMPv3 (obrázek 2.7, \cite{macejko_dipl})}
		\label{obr_snmp4}
	\end{center}
\end{figure}
