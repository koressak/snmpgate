...
které vedly ke zdárnému dokončení práce. Zároveň můj dík patří i rodině za podporu po celou dobu mých
studií.


%%%%%%%%%%%%%%%%%%%%%%%%%%%   Prohlaseni / Declaration 

\declaration{V Praze dne 13.\,5.\,2009}
...
\include{03_xml}
\include{04_analyza}
\include{05_implementace}
\include{06_testovani}
\include{07_zaver}
...
\include{0A_konfig_file}
\include{0B_uzivat_brana}
\include{0C_uzivat_manager}
\include{0D_obsahcd}
