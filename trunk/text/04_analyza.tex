...
Informace budou posílány ve formátu HTTP POST zprávy. Strukturu dotazu a odpovědi zobrazuje obrázek \ref{obr_an_http_post}.
...
V tomt místě jsou možné dvě cesty, jak vybudovat výstupní XML dokument. Jednou možností je zahrnout všechny informace do jednoho souboru, který potom bude rozesílán každému manažerovi, jenž si o něj řekne. Tato varianta
...
SNMP modul bude komunikovat pomocí protokolu UDP, posíláním SNMP zpráv. O tuto část se postará knihovna. Tato část rozhraní bude blíže popsána v následující kapitole.
...
Součástí této práce je i implementace základního XML manažera tak, aby dovolil ukázat veškeré funkční aspekty protokolové brány. V této sekci budou shrnuty základní požadavky, které musí manažerská aplikace splňovat.
