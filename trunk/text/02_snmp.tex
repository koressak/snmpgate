...
Komunikace můžeme rozdělit do dvou kategorií dle toho, kdo jí započal. Základní schéma je vyjádřeno na obrázku \ref{obr_snmp2}.
...
Strukturu jednotlivých SNMP paketů zobrazuje obrázek \ref{obr_snmp3}. Pro pochopení významu jednotlivých polí se obraťte na \cite{RFC1157}.
%TODO: Dodelat popis SNMP PDU. Nazeneme tim nejake misto
%TODO: vypsat i TRAP PDU a popis
